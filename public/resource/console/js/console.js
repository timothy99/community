...
function ajax1(ajax_url, form_data, callback) {
    $('<div id="progress" style="display:none;"><div id="progress_loading"><img id="loading_img" src="/resource/console/images/loading.gif"/></div></div>').appendTo(document.body).show();
