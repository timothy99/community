...
create table mng_board_comment (
    ...
    secret_yn enum('Y', 'N') default 'N' not null comment '비밀 댓글 여부',
    del_yn enum('Y', 'N') not null comment '삭제 여부',
    ins_id varchar(70) default null comment '입력자',
    ins_date varchar(14) not null comment '입력일',
    upd_id varchar(70) default null comment '수정자',
...
create table mng_board_config (
    ...
    secret_comment_yn enum('Y', 'N') default 'N' not null comment '비밀 댓글 기능 사용 여부',
    title varchar(1000) not null comment '제목',
...
create table mng_config (
    ...
    admin_two_factor_yn enum('Y', 'N') default 'N' null comment '관리자 접속시 2차 인증 사용 여부',
    admin_ip_check_yn enum('Y', 'N') default 'N' null comment '관리자 접속시 IP 확인 여부',
