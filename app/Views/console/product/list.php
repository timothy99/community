...
<?php       } ?>
            ...
            <div class="card-footer text-end">
                <div class="d-flex gap-2 justify-content-end">
                    ...
                    <a href="/csl/product/list" class="btn btn-secondary">초기화</a>
                </div>
            </div>
        </div>
...
<?php       } ?>
                                ...
                                <td class="text-start"><a href="/csl/product/view/<?= $val->product_idx ?>" class="link-body-emphasis"><?= $val->title ?></a></td>
                                <td><?= code_replace('display_yn', $val->display_yn) ?></td>
...
<?= $paging_info['paging_view'] ?>
                    ...
                    <div class="d-flex gap-2 justify-content-end align-self-end">
                        <a href="/csl/product/write" class="btn btn-primary">등록</a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function search() {
        ...
        location.href = '/csl/product/list?search_page='+search_page+'&search_text='+search_text+'&search_condition='+search_condition+'&search_rows='+search_rows+'&search_language='+search_language+'&product_category_idx1='+product_category_idx1+'&product_category_idx2='+product_category_idx2+'&product_category_idx3='+product_category_idx3;
    }
</script>