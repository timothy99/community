            ...
            <div class="card-body p-3">
                <div class="border-top">
                    ...
                    <div class="row g-0 border-bottom">
                        <div class="tbl-label">언어</div>
                        <div class="tbl-value"><?= code_replace('language', $info->language) ?></div>
                    </div>
...
<?php   } ?>
                    ...
                    <!-- 노출여부 -->
                    <div class="row g-0 border-bottom">
                        <div class="tbl-label">노출여부</div>
                        <div class="tbl-value"><?= code_replace('display_yn', $info->display_yn) ?></div>
                    </div>
...
<?php   } ?>
            ...
            <div class="card-footer text-end">
                <div class="d-flex gap-2 justify-content-end">
                    <button type="button" class="btn btn-danger" onclick="productDelete()">삭제</button>
                    <a href="/csl/product/list" class="btn btn-secondary">목록</a>
                    <a href="/csl/product/edit/<?= $info->product_idx ?>" class="btn btn-primary">수정</a>
                </div>
            </div>
        </div>
