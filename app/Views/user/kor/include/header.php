...
<html lang="ko">
    <head>
        ...
        <link href="//fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@400;500;700&display=swap" rel="stylesheet"><!-- Noto Sans KR -->
        ...
        <script src="/resource/user/js/summernote_setting.js?ver=<?= $config_info->program_ver ?>"></script><!-- 썸머노트 설정 -->

        <script src="//t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
        <script src="/resource/user/js/postcode.js?ver=<?= $config_info->program_ver ?>"></script>

        <script src="/resource/user/js/user.js?ver=<?= $config_info->program_ver ?>"></script>
        <link rel="stylesheet" href="/resource/user/css/user.css?ver=<?= $config_info->program_ver ?>">
    </head>
